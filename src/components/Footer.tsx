...
export const Footer: React.FC<FooterProps> = ({ onNavigate, onOpenAuth }) => {
  ...
  return (
    <footer className="w-full bg-[#f8f9fa] text-gray-700 font-sans border-t border-gray-200 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center pb-8 mb-8 border-b border-gray-200">
          ...
          <div className="md:col-span-3">
            <button 
              ...
              className="text-3xl font-extrabold text-[#00c8db] tracking-tight text-left focus:outline-none cursor-pointer"
            >
              LaKavern
            </button>
          </div>
          ...
          {/* Réseaux Sociaux */}
          <div className="md:col-span-3 flex items-center space-x-3 text-gray-700">
            {/* Facebook */}
            <a
              href="https://www.facebook.com/lakavern"
              target="_blank"
              rel="noopener noreferrer"
              className="p-2 hover:text-[#00c8db] transition-colors cursor-pointer inline-flex items-center justify-center"
              aria-label="Facebook"
            >
            ...
            {/* Instagram */}
            <a
              href="https://www.instagram.com/lakavern/"
              target="_blank"
              rel="noopener noreferrer"
              className="p-2 hover:text-[#00c8db] transition-colors cursor-pointer inline-flex items-center justify-center"
            ...
            {/* TikTok */}
            <a
              href="https://www.tiktok.com/@lakavern"
              target="_blank"
              rel="noopener noreferrer"
              className="p-2 hover:text-[#00c8db] transition-colors cursor-pointer inline-flex items-center justify-center font-bold text-sm"
              aria-label="TikTok"
            >
              <svg className="w-8 h-4 fill-current pointer-events-none" viewBox="0 0 24 24">
          ...
          <div className="md:col-span-6 flex">
            ...
            />
            <button className="bg-[#00c8db] hover:bg-[#00b3c4] text-white font-bold px-8 py-2.5 text-sm uppercase tracking-wider transition-colors flex-shrink-0 cursor-pointer">
              INSCRIRE
            </button>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-sm">
          ...
          <div className="space-y-3">
            ...
            <a href="mailto:kange.prestations@gmail.com" className="block text-gray-600 hover:text-[#00c8db]">
              kange.prestations@gmail.com
            </a>
            <a href="https://lakavernshop.com/" target="_blank" rel="noopener noreferrer" className="block text-gray-600 hover:text-[#00c8db]">
              lakavernshop.com
            </a>
          </div>
          ...
          <div className="space-y-3 font-semibold">
            <button 
              onClick={() => onNavigate && onNavigate('home')} 
              className="block text-gray-800 hover:text-[#00c8db] text-left cursor-pointer"
            >
              ACCUEIL
            </button>
            <button 
          ...
          <button 
            ...
            className="hover:text-[#00c8db] transition-colors text-left cursor-pointer font-medium"
            >
          ...
          <li>
            <button 
              ...
              className="block text-gray-600 hover:text-[#00c8db] text-left cursor-pointer"
            >
              Mon compte
            </button>
          </li>
      ...
      <button
        onClick={scrollToTop}
        className="fixed bottom-20 right-6 bg-white border border-gray-200 text-gray-700 p-2.5 rounded-full shadow-md hover:bg-gray-50 transition-all z-40 cursor-pointer"
      ...
      >
        <MessageCircle className="w-7 h-7 fill-current stroke-none pointer-events-none" />
      </a>
